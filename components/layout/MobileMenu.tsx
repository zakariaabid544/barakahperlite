            ...
            {open ? (
              ...
              >
                ...
                <div className="relative mx-auto flex min-h-[calc(100svh-2rem)] max-w-lg flex-col">
                  <div className="flex items-center justify-between rounded-[0.55rem] border border-white/10 bg-white/[0.045] px-4 py-3 shadow-glass">
                    <div>
                    ...
                    <button
                      ...
                      className="inline-flex h-11 w-11 items-center justify-center rounded-[0.45rem] border border-white/10 bg-basalt-950/70 text-perlite-50 transition hover:border-agritech-emerald/50 hover:bg-white/[0.07] focus:outline-none focus-visible:ring-2 focus-visible:ring-agritech-emerald"
                    >
                    ...
                    {navItems.map((item) => {
                      ...
                      return (
                        <Link
                          ...
                          onClick={() => setOpen(false)}
                          className={cn(
                            "group flex items-center justify-between rounded-[0.55rem] border border-white/10 bg-white/[0.045] px-5 py-4 text-lg font-medium text-silver-100 shadow-glass transition hover:border-agritech-emerald/35 hover:bg-white/[0.075] hover:text-perlite-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-agritech-emerald",
                            active &&
                  ...
                  <div className="mt-5 grid gap-3 rounded-[0.55rem] border border-white/10 bg-basalt-900/55 p-4 shadow-glass">
                    <Link
  ...
  return (
    <div className="min-[1180px]:hidden">
      <button
        ...
        className="inline-flex h-12 w-12 items-center justify-center rounded-[0.45rem] border border-white/10 bg-white/[0.065] text-perlite-50 shadow-glass backdrop-blur-xl transition hover:border-agritech-emerald/50 hover:bg-white/[0.09] focus:outline-none focus-visible:ring-2 focus-visible:ring-agritech-emerald"
      >
